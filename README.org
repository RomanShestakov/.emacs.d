...
Then recompile the vterm module with M-x vterm-module-compile if you see any errors.                                                                                                                         
...
** tmux - how to copy text between tmux windows
shift-select text to copy to buffer
shift middle mouse button click - paste 
